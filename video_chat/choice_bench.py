...
def answer(conv, model, img_list, max_new_tokens=200, num_beams=1, min_length=1, top_p=0.9,
    ...
    conv.messages.append([conv.roles[1], "Best Option: ("])
...
if name=="all":
    data_list = {
    # "count": ("count.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/count", "video", False),
    # "ego": ("ego.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/ego", "video", False),
    # "needle": ("needle.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/needle", "video", False),
    # "order": ("order.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/order", "video", False),
    # "plotQA": ("plotQA.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/plotQA", "video", False),
    "anomaly_reco": ("anomaly_reco.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/anomaly_reco", "video", False),
    "topic_reasoning": ("topic_reasoning.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/topic_reasoning", "video", False)
}
else:
    data_list = {
    "count": ("count.json", f"/share/junjie/code/videofactory/Evaluation_LVBench/LVBench_{name}/video/count", "video", False),
...
save_path = f"./test_{name}_choice"
result_path=f"bench_{name}.json"
...
for example in tqdm(dataset):
    ...
    ask(question, chat)
    pred = answer(conv=chat, model=model, img_list=img_list, max_new_tokens=100)[0]
