...
if __name__ == "__main__":
    ...
    parser.add_argument("--predict_json", default="subplot_60_pred.json", help="prediction json file.")
    parser.add_argument("--target_json", default="subplot_60_gt.json", help="ground truth json file.")
    ...
    _, _, score = bert_score_compute(pds_all, gts_all, lang='en', verbose=False,model_type="roberta-large")
