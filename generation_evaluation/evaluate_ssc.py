...
def parse_args():
    ...
    parser.add_argument("--pred_path", default="/share/junjie/code/evaluation_lvbench/qwen/16_subPlot_all.json", help="The path to file containing prediction.")
    ...
    parser.add_argument("--api_key", default="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", help="OpenAI API key.")
