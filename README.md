...
## :bell: News:
- 🚀 3/18/2025: We released the ground truth for the MLVU test set, which is more challenging than the dev set and includes two new tasks: Tutorial QA and Sports QA. The MLVU test set has also been integrated into [lmms-eval](https://github.com/EvolvingLMMs-Lab/lmms-eval)! You can now conveniently evaluate the multiple-choice questions (MLVU<sub>M</sub>) for both the Dev set and the Test set with a single click using lmms-eval. Thanks to the lmms-eval team! 🔥
- 🎉 2/27/2024: MLVU has been accepted by CVPR 2025!
...
| --- | --- | --- | --- | --- |
| Full mark | - | - | 100 | 10 |
| [LVAgent](https://github.com/64327069/LVAgent) | 116 frm | (2*72+7)B  | 83.9 | -- |
| [TSPO](https://github.com/Hui-design/TSPO) | 64 frm | 72B | 77.3 | -- |
| [TSPO](https://github.com/Hui-design/TSPO) | 64 frm | 7B | 76.3 | -- |
