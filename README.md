...
## :bell: News:
- 📢 11/3/2024: **Note**: We apologize for the temporary downtime of the Test set evaluation website. With the CVPR deadline approaching, we recommend using [lmmseval](https://github.com/EvolvingLMMs-Lab/lmms-eval?tab=readme-ov-file) for quick, one-click evaluations on the **MLVU-Dev** set. For the **MLVU-Test** set, we will assist with evaluations via email during this period. Please format your Test results according to the [guidelines](https://github.com/JUNJIE99/MLVU/tree/main/evaluation_test) and send them to zhoujunjie[#]bupt.edu.cn or 570533048[#]qq.com. If you want your model to appear on the leaderboard, feel free to contact us. (Please replace # with [at]. We typically respond within one day.) 🔥
...
| --- | --- | --- | --- | --- |
| Full mark | - | - | 100 | 10 |
| [VideoChat2-Flash](https://github.com/OpenGVLab/VideoChat-Flash) | - | 7B | 74.7 | -- |
| [VideoLLaMA3](https://github.com/DAMO-NLP-SG/VideoLLaMA3) | <=128 frm | 7B | 73.0 | -- |
...
| [LinVT](https://github.com/gls0425/LinVT) | 120 frm | 7B | 68.9 | -- |
...
| [Video-LLaMA3](https://github.com/DAMO-NLP-SG/VideoLLaMA3)| <=128 frm | 7B | 82.4  | 41.0  | 61.7  | 52.8  | 64.0  | 24.3  | 21.7  | 33.3  | 27.9  | 45.5  | 5.02 | 3.20 | 4.07 |
